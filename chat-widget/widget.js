(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '#hbuddy .hb-sidebar-overlay{position:absolute;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);z-index:10;opacity:0;pointer-events:none;transition:opacity .3s ease}',
      '#hbuddy .hb-sidebar-overlay.hb-visible{opacity:1;pointer-events:all}',
      '#hbuddy .hb-sidebar{position:absolute;top:0;right:0;bottom:0;width:200px;background:#0d0d0d;border-left:1px solid rgba(230,57,70,0.12);z-index:11;display:flex;flex-direction:column;padding:24px 16px;transform:translateX(100%);transition:transform .3s cubic-bezier(0.16,1,0.3,1)}',
