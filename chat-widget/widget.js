(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '#hbuddy .hb-sidebar{position:absolute;top:0;right:0;bottom:0;width:200px;background:#0d0d0d;border-left:1px solid rgba(230,57,70,0.12);z-index:11;display:none;flex-direction:column;padding:24px 16px}',
